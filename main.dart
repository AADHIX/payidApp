                      ...
                      showDialog(
                        ...
                        builder: (BuildContext context) {
                          return AlertDialog(
                            ...
                            content: const Text(
                              'Are you sure you want to process payment of \$130.80?',
                              ...
                              ElevatedButton(
                                onPressed: () {
                                  ...
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => const CardAddedScreen(),
                                    ),
                                  );
                                },
    ...
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          child: Text(value, style: AppTheme.bodyStyle),
        ),
      ],
    );
  }
...
class CardAddedScreen extends StatelessWidget {
  const CardAddedScreen({Key? key}) : super(key: key);
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: const Text('John Henry', style: AppTheme.bodyStyle),
                ),
